...
-- Tarea 3: Realizar operaciones de actualizaci�n en datos JSON
...
UPDATE datos_adicionales
SET datos = JSON_MODIFY(datos, '$.preferencias.musica', null)
WHERE usuarios_id = 1;
...
-- Tarea 5: Aproximaciones a la optimizaci�n de consultas para estas estructuras
...
-- Tarea 6: Eliminar un registro espec�fico de datos adicionales
